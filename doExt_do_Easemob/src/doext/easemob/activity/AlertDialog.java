...
import doext.easemob.task.DownloadImageTask;
...
public class AlertDialog extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(DoResourcesHelper.getIdentifier("alert_dialog", "layout", this));
		mTextView = (TextView) findViewById(DoResourcesHelper.getIdentifier("title","id",this));
		mButton = (Button) findViewById(DoResourcesHelper.getIdentifier("btn_cancel","id",this));
		imageView = (ImageView) findViewById(DoResourcesHelper.getIdentifier("image","id",this));
		editText = (EditText) findViewById(DoResourcesHelper.getIdentifier("edit","id",this));
		//提示内容
		...
		if(msg != null)
		    ((TextView)findViewById(DoResourcesHelper.getIdentifier("alert_message","id",this))).setText(msg);
		if(title != null)
		...
		if(path != null){
		    ...
		    ((TextView)findViewById(DoResourcesHelper.getIdentifier("alert_message","id",this))).setVisibility(View.GONE);
